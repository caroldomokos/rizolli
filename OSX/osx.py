...
if latestReleaseNr == configuredReleaseNr:
	...
	noChangeNeededFile = codecs.open('/home/gufi/PYTHON_Learning/noChangeNeeded.txt', encoding='utf-8', mode= 'w+')
...
#		json.dump(osxDict, output)
	print 'Change needed!!!!!'
        # convert latest releas nr to string so we can add to file
        latestReleaseNrStr = str(latestReleaseNr)
        ChangeNeededFile = codecs.open('/home/gufi/PYTHON_Learning/ChangeNeeded.txt', encoding='utf-8', mode= 'w+')
